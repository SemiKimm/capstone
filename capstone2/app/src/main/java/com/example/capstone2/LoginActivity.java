...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postingButton.setOnClickListener(view -> {
            Intent intent=new Intent(LoginActivity.this, SelectPostingActivity.class);
            startActivity(intent);
        });

        Button searchButton=findViewById(R.id.searchBtn);
        searchButton.setOnClickListener(view -> {
            Intent intent=new Intent(LoginActivity.this, SelectSearchPostActivity.class);
            startActivity(intent);
        });
        ...
        login_button.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.e("logincheck","로그인성공0");
                Response.Listener<String> responseListener = new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            Log.e("logincheck","로그인성공1");
                            JSONObject jsonObject = new JSONObject( response );
                            Log.e("logincheck","로그인성공2");
                            ...
                            if(success) {//로그인 성공시
                                ...
                                if(count >= 5){ //신고횟수 파악
                                    ...
                                    editor.commit();
                                    Log.e("user_token 확인",String.valueOf(editor));
                                    // 로그인 성공 메시지 출력
