...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //마이페이지 또는 로그인으로 이동
        Button myPageButton = findViewById(R.id.myPageBtn);
        ...
        Button checkBtn=findViewById(R.id.check);
        checkBtn.setOnClickListener(view -> {
            Intent intent= new Intent(this,PushGetCheckActivity.class);
            startActivity(intent);
        });
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for(int i=0;i<jsonArray.length();i++){
                                ...
                                String test = "{test=true,1234=true}";

//                                String test = hashMap.get("LostPostDateData");
//                                Log.e("hashmaptest",String.valueOf(hashMap));
//                                Log.e("losttest",String.valueOf(test));
                            }
                            if(success){
                                ListAdapter adapter = new SimpleAdapter(
