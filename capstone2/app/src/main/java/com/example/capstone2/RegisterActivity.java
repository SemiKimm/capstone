...
public class RegisterActivity extends AppCompatActivity {
    ...
    private String join_User_Token;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseInstanceId.getInstance().getInstanceId().addOnSuccessListener( RegisterActivity.this,
            ...
            public void onSuccess(InstanceIdResult instanceIdResult) {
                join_User_Token = instanceIdResult.getToken();
                Log.e("newToken", join_User_Token);
            }
        });
        ...
        join_button.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String user_token = join_User_Token.toString();
                ...
                RegisterRequest registerRequest = new RegisterRequest( login_id, login_pwd,user_name, user_phone,user_token, responseListener);
                RequestQueue queue = Volley.newRequestQueue( RegisterActivity.this );
