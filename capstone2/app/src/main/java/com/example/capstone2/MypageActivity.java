...
public class MypageActivity extends AppCompatActivity {
    ...
    final private String url1 = "http://jamong.ivyro.net/GetMyPostGetJson.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postingButton.setOnClickListener(view -> {
            Intent intent=new Intent(MypageActivity.this, SelectPostingActivity.class);
            startActivity(intent);
        });

        Button searchButton=findViewById(R.id.searchBtn);
        searchButton.setOnClickListener(view -> {
            Intent intent=new Intent(MypageActivity.this, SelectSearchPostActivity.class);
            startActivity(intent);
        });
...
//        });
        ...
        mlistView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View v, int position, long id) {
                ...
                Intent intent = new Intent(MypageActivity.this, GetPostActivity.class);
        ...
        protected  void onPostExecute(String result){
            ...
            if(result != null) {
                try {
                    ...
                    Log.e("loginjsoncheck", String.valueOf(jsonObject));
